...
class Block(nn.Module):
    def __init__(self, in_channels, out_channels, d, bottleneck = False):
        ...
        if bottleneck:
            ...
            self.F.add_module('conv2', nn.Conv2d(hidden_channels, hidden_channels, kernel_size = 3, padding = 1, bias = False))
...
class SC(nn.Module):
    def __init__(self, d, C, n, dropout, num_class = 10, bottleneck = False):
        ...
        self.layer1 = BasicBlock(64,256,d,C,n,[dropout[0],dropout[0]+drop_step], bottleneck = bottleneck)
        self.layer2 = BasicBlock(256,512,d,C,n,[dropout[0]+drop_step,dropout[0]+2*drop_step], bottleneck = bottleneck)
        self.layer3 = BasicBlock(512,1024,d,C,n,[dropout[0]+2*drop_step,dropout[1]], bottleneck = bottleneck)
